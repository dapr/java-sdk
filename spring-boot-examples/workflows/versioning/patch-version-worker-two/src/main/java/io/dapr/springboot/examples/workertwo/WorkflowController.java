...
public class WorkflowController {
  ...
  public static final String PATCH_VERSION_WORKFLOW = "PatchVersionWorkflow";
   ...
   */
  @PostMapping("/version/patch")
  public String createWorkflowInstance() {
    String instanceId = daprWorkflowClient.scheduleNewWorkflow(PATCH_VERSION_WORKFLOW);
   ...
   */
  @PostMapping("/version/patch/followup/{instanceId}")
   ...
   */
  @PostMapping("/version/patch/status/{instanceId}")
