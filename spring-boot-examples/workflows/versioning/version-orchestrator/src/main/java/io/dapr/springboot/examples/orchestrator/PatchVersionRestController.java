...
@RestController
public class PatchVersionRestController {
  public static final String V1_URL = "http://localhost:8083";
  public static final String V2_URL = "http://localhost:8084";
  private final String V1 = "v1";
  private final String V2 = "v2";

  private final Logger logger = LoggerFactory.getLogger(PatchVersionRestController.class);
   ...
   */
  @PostMapping("/version/{version}/patch")
  public String createWorkflowInstance(@PathVariable("version") String version) throws Exception {
    ...
    var request = java.net.http.HttpRequest.newBuilder()
        .uri(java.net.URI.create(url + "/version/patch"))
   ...
   */
  @PostMapping("/version/{version}/patch/followup/{instanceId}")
  public String followUp(@PathVariable("version") String version, @PathVariable("instanceId") String instanceId) throws Exception {
    ...
    var url = getUrlForVersion(version);
    var request = java.net.http.HttpRequest.newBuilder()
        .uri(java.net.URI.create(url + "/version/patch/followup/" + instanceId))
        .POST(java.net.http.HttpRequest.BodyPublishers.noBody())
        .header("Content-Type", "application/json")
        .build();
   ...
   */
  @PostMapping("/version/{version}/patch/status/{instanceId}")
  public String getStatus(@PathVariable("version") String version, @PathVariable("instanceId") String instanceId) throws Exception {
    ...
    var url = getUrlForVersion(version);
    var request = java.net.http.HttpRequest.newBuilder()
        .uri(java.net.URI.create(url + "/version/patch/status/" + instanceId))
        .POST(java.net.http.HttpRequest.BodyPublishers.noBody())
        .header("Content-Type", "application/json")
        .build();
