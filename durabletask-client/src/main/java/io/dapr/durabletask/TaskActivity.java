 ...
 * activity. These activities may be executed serially, in parallel, or some combination of both.</p>
 *
 ...
 * <strong>at least once</strong> during an orchestration's execution.</p>
 *
 * <p>Because activities only guarantee at least once execution, it's recommended that activity logic be implemented as
 * idempotent whenever possible.</p>
 *
 * <p>Activities are scheduled by orchestrators using one of the {@link TaskOrchestrationContext#callActivity} method
 * overloads.</p>
 */
@FunctionalInterface
