...
@Configuration
public class DemoActorRuntimeRegistrationConfiguration {

  @Bean
  public DemoActorRuntimeRegistrar demoActorRuntimeRegistrar(ActorRuntime actorRuntime) {
    return new DemoActorRuntimeRegistrar(actorRuntime);
  }

  static final class DemoActorRuntimeRegistrar {
    private final ActorRuntime actorRuntime;

    private DemoActorRuntimeRegistrar(ActorRuntime actorRuntime) {
