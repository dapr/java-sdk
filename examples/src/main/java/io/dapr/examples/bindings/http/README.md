...
dapr run --app-id inputbinding --app-port 3000 --port 3005 -- java -jar target/dapr-sdk-examples-0.2.0-SNAPSHOT-exec.jar io.dapr.examples.bindings.http.InputBindingExample -p 3000
```
...
```sh
cd to [repo-root]/examples
dapr run --app-id outputbinding --port 3006 -- java -jar target/dapr-sdk-examples-0.2.0-SNAPSHOT-exec.jar io.dapr.examples.bindings.http.OutputBindingExample
```
