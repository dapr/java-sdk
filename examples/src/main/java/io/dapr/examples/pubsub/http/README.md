...
```sh
dapr run --app-id subscriber --app-port 3000 --port 3005 -- java -jar examples/target/dapr-sdk-examples-0.2.0-SNAPSHOT-exec.jar io.dapr.examples.pubsub.http.Subscriber -p 3000
```
...
```sh
dapr run --app-id publisher --port 3006 -- java -jar examples/target/dapr-sdk-examples-0.2.0-SNAPSHOT-exec.jar io.dapr.examples.pubsub.http.Publisher
```
