 ...
 * <p>Each request:
 * <ol>
 *   <li>Runs the {@link ResearchWriter} agent's ReAct loop as a {@code react-agent} workflow.</li>
 *   <li>Each LLM tool call ({@code getPopulation} / {@code getCapital}) is executed as an
 *       {@code agent-tool} Dapr Workflow Activity.</li>
 * </ol>
 *
 * <p>Example usage:
 * <pre>
