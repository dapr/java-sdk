 ...
 *       {@link io.dapr.quarkus.langchain4j.agent.workflow.AgentRunWorkflow}.</li>
 *   <li>The decorator blocks the agent thread on a {@link CompletableFuture}.</li>
 *   <li>{@link io.dapr.quarkus.langchain4j.agent.activities.LlmCallActivity} picks up
 ...
 * an {@link io.dapr.quarkus.langchain4j.agent.workflow.AgentRunWorkflow} so that all
