 ...
 *
 * <p>For standalone {@code @Agent} calls, the workflow lifecycle is instead managed lazily by
 ...
 *
 * <p>This class is retained for use cases where {@code @Agent} methods are declared on
...
public class DaprAgentMethodInterceptor {
  ...
  /**
   * Intercepts {@code @Agent}-annotated method calls and starts a Dapr workflow.
   *
  ...
  public Object intercept(InvocationContext ctx) throws Exception {
    ...
    try {
      ...
      LOG.infof("[AgentRun:%s] DaprAgentMethodInterceptor: @Agent method completed, sending done event",
          agentRunId);
