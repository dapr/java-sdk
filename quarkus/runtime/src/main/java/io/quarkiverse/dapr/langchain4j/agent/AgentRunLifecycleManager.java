...
public class AgentRunLifecycleManager {
   ...
   *
   * <p>When no decorator was generated (e.g., the lazy-activation fallback path used by
   ...
   *
   * <p>In the normal flow the generated CDI decorator already called {@link #triggerDone()},
