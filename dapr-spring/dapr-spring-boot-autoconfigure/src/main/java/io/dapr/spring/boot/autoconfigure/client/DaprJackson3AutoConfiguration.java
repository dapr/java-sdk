 ...
 * {@link JsonMapper} bean) and before {@link DaprClientAutoConfiguration} (which consumes it).
 */
@AutoConfiguration(after = JacksonAutoConfiguration.class, before = DaprClientAutoConfiguration.class)
@ConditionalOnClass(JsonMapper.class)
public class DaprJackson3AutoConfiguration {
