...
public class DaprClientImpl extends AbstractDaprClient {
  ...
  public Mono<Map<String, String>> getSecret(GetSecretRequest request) {
    ...
    return Mono.deferContextual(
        context ->
            this.<DaprSecretProtos.GetSecretResponse>createMono(
  ...
  public Mono<Map<String, ConfigurationItem>> getConfiguration(GetConfigurationRequest request) {
    try {
      ...
      DaprConfigurationProtos.GetConfigurationRequest.Builder builder =
          DaprConfigurationProtos.GetConfigurationRequest.newBuilder()
  ...
  private Mono<Map<String, ConfigurationItem>> getConfiguration(
      DaprConfigurationProtos.GetConfigurationRequest envelope) {
    return Mono.deferContextual(
        context ->
  ...
  public Flux<SubscribeConfigurationResponse> subscribeConfiguration(SubscribeConfigurationRequest request) {
    try {
      ...
      DaprConfigurationProtos.SubscribeConfigurationRequest.Builder builder =
          DaprConfigurationProtos.SubscribeConfigurationRequest.newBuilder()
      ...
      return this.<DaprConfigurationProtos.SubscribeConfigurationResponse>createFlux(
          it ->
              intercept(null, asyncStub).subscribeConfiguration(envelope, it)
      ).map(
          it -> {
            Map<String, ConfigurationItem> configMap = new HashMap<>();
  ...
  public Flux<byte[]> encrypt(EncryptRequestAlpha1 request) {
    try {
      ...
      return Flux.create(sink -> {
        ...
        DaprCryptoProtos.EncryptRequestOptions.Builder optionsBuilder =
            DaprCryptoProtos.EncryptRequestOptions.newBuilder()
