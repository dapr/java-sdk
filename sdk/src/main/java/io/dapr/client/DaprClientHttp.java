...
public class DaprClientHttp extends AbstractDaprClient {
    ...
    try {
      ...
      return Mono.deferContextual(
          context -> this.client.invokeApi(
              DaprHttp.HttpMethods.POST.name(), pathSegments, queryArgs, serializedEvent, headers,
                  Context.of(context))
      ).then();
    } catch (Exception ex) {
    ...
    try {
      ...
      Mono<DaprHttp.Response> response = Mono.deferContextual(
          context -> this.client.invokeApi(httpMethod, pathSegments.toArray(new String[0]),
              httpExtension.getQueryParams(), serializedRequestBody, headers, Context.of(context))
      );
  ...
  public <T> Mono<T> invokeBinding(InvokeBindingRequest request, TypeRef<T> type) {
    try {
      ...
      Mono<DaprHttp.Response> response = Mono.deferContextual(
          context -> this.client.invokeApi(
              httpMethod, pathSegments, null, payload, null, Context.of(context))
      );
      return response.flatMap(r -> getMono(type, r));
    } catch (Exception ex) {
      return DaprException.wrapMono(ex);
  ...
  public <T> Mono<List<State<T>>> getBulkState(GetBulkStateRequest request, TypeRef<T> type) {
    try {
      ...
      return Mono.deferContextual(context -> this.client.invokeApi(
                    DaprHttp.HttpMethods.POST.name(), pathSegments, queryArgs, requestBody,
                        null, Context.of(context)))
        .flatMap(s -> {
          try {
  ...
  public <T> Mono<State<T>> getState(GetStateRequest request, TypeRef<T> type) {
    try {
      ...
      return Mono.deferContextual(
          context -> this.client
              .invokeApi(DaprHttp.HttpMethods.GET.name(), pathSegments, queryParams, null,
                      Context.of(context))
      ).flatMap(s -> {
        try {
  ...
  public Mono<Void> executeStateTransaction(ExecuteStateTransactionRequest request) {
    try {
      ...
      return Mono.deferContextual(
          context -> this.client.invokeApi(
              DaprHttp.HttpMethods.POST.name(), pathSegments, null, serializedOperationBody, null,
                  Context.of(context)
          )
      ).then();
    } catch (Exception e) {
  ...
  public Mono<Void> saveBulkState(SaveStateRequest request) {
    try {
      ...
      return Mono.deferContextual(
          context -> this.client.invokeApi(
              DaprHttp.HttpMethods.POST.name(), pathSegments, null, serializedStateBody, null,
                  Context.of(context))
      ).then();
    } catch (Exception ex) {
      return DaprException.wrapMono(ex);
  ...
  public Mono<Void> deleteState(DeleteStateRequest request) {
    try {
      ...
      return Mono.deferContextual(
          context -> this.client.invokeApi(
              DaprHttp.HttpMethods.DELETE.name(), pathSegments, queryParams, headers,
                  Context.of(context))
      ).then();
    } catch (Exception ex) {
      return DaprException.wrapMono(ex);
  ...
  public Mono<Map<String, String>> getSecret(GetSecretRequest request) {
    ...
    return Mono.deferContextual(
            context -> this.client
                .invokeApi(DaprHttp.HttpMethods.GET.name(), pathSegments, queryArgs, (String) null, null,
                            Context.of(context))
        ).flatMap(response -> {
          try {
      ...
      return Mono.deferContextual(
              context -> this.client
                  .invokeApi(DaprHttp.HttpMethods.POST.name(), pathSegments,
                      queryArgs, serializedRequest, null, Context.of(context))
          ).flatMap(response -> {
            try {
      ...
      return Mono.deferContextual(
              context -> this.client
                      .invokeApi(
                              ...
                              (String) null, null, Context.of(context))
      ).map(
              response -> {
                try {
                  Map m = INTERNAL_SERIALIZER.deserialize(response.getBody(), Map.class);
