...
public class DaprClientHttpAdapterTest {
    ...
    public void getStates() {
        StateKeyValue<String> stateKeyValue = new StateKeyValue("value", "key", "etag");
        StateKeyValue<String> stateKeyNull = new StateKeyValue("value", null, "etag");
    ...
    public void getStatesEmptyEtag() {
        StateKeyValue<String> stateEmptyEtag = new StateKeyValue("value", "key", "");
        mockInterceptor.addRule()
            .get("http://localhost:3000/v1.0/state/key")
            .respond(EXPECTED_RESULT);
        daprHttp = new DaprHttp(3000, okHttpClient);
    ...
    public void getStatesNullEtag() {
        StateKeyValue<String> stateNullEtag = new StateKeyValue("value", "key", null);
        mockInterceptor.addRule()
            .get("http://localhost:3000/v1.0/state/key")
            .respond(EXPECTED_RESULT);
        daprHttp = new DaprHttp(3000, okHttpClient);
    ...
    public void saveStates() {
        ...
        daprHttp = new DaprHttp(3000, okHttpClient);
        daprClientHttpAdapter = new DaprClientHttpAdapter(daprHttp);
        Mono<Void> mono = daprClientHttpAdapter.saveStates(stateKeyValueList, null);
        assertNull(mono.block());
    }

    @Test
    public void saveStatesNull() {
        StateKeyValue<String> stateKeyValue = new StateKeyValue("value", "key", "");
        ...
        daprHttp = new DaprHttp(3000, okHttpClient);
        daprClientHttpAdapter = new DaprClientHttpAdapter(daprHttp);
        Mono<Void> mono = daprClientHttpAdapter.saveStates(null, null);
        assertNull(mono.block());
        Mono<Void> mono1 = daprClientHttpAdapter.saveStates(stateKeyValueList, null);
    ...
    public void deleteStateIllegalArgumentException() {
        StateKeyValue<String> stateKeyValueNull = new StateKeyValue("value", null, "etag");
        StateKeyValue<String> stateKeyValueEmpty = new StateKeyValue("value", "", "etag");
        mockInterceptor.addRule()
            .delete("http://localhost:3000/v1.0/state/key")
            .respond(EXPECTED_RESULT);
        daprHttp = new DaprHttp(3000, okHttpClient);
