...
public interface WorkflowContext {
   ...
   *
   * <p>The returned logger is a no-op logger while the workflow is replaying, so that log
   ...
   *
   * <p>See {@link #callChildWorkflow(String, Object, String, WorkflowTaskOptions, Class)} for a full description.</p>
   *
