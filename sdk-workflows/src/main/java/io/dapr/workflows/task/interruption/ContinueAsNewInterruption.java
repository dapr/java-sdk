...
package io.dapr.workflows.task.interruption;

import io.dapr.workflows.WorkflowContext;

/**
 * Control flow {@code Throwable} class for orchestrator when invoke {@link WorkflowContext#continueAsNew}.
 * This {@code Throwable} must never be caught by user
 * code.
 *
 * <p>{@code ContinueAsNewInterruption} is thrown when an orchestrator calls
 * {@link WorkflowContext#continueAsNew}.
